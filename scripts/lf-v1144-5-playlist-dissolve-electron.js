...
function staticChecks() {
  ...
  pass('delete particles are numerous, small, RGB white, and unblurred', /target = reducedMotion\(\) \? 220 : 1600/.test(sampler) && /size:0\.45 \+ Math\.random\(\) \* 0\.72/.test(sampler) && /r:248,\s*g:250,\s*b:255/.test(sampler) && /context\.shadowBlur = 0/.test(effect), true);
